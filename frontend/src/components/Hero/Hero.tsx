      ...
      <div className={styles.inner}>
        <div>
          ...
          <h1 className={styles.name}>
            <span className={styles.first}>Ekansh</span>
            <br />
          ...
          <p className={styles.desc}>
            Building scalable, production-grade web applications for global
            platforms. 4+ years of shipping real products — from 100+ GraphQL
            APIs to proactive supply chain security. Based in{" "}
