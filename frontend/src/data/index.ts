...
export const TECH_RINGS: TechRings = {
  ...
  r3: [
    ...
    {
      name: "SonarQube",
      img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/sonarqube/sonarqube-original.svg",
    },
  ],
};
...
export const EXPERIENCE: ExperienceItem[] = [
  {
    ...
    bullets: [
      "Architected and delivered 100+ GraphQL APIs in Node.js, serving 28,000+ global users — optimised query depth and payload to reduce API response time by ~35%.",
